(() => {
  ...
  var Tr = c(() => {
    ...
    window.tram = (function (e) {
      ...
      function o(l, E, m) {
        return (
          "#" + ((1 << 24) | (l << 16) | (E << 8) | m).toString(16).slice(1)
        );
      }
      function i() {}
      function a(l, E) {
      ...
      var p = (function (l, E, m) {
          ...
          function W($, k) {
            ...
            return (
              ...
              (x.open = function (ye) {
                if (
                  ((ne = {}),
                  N(ye) ? (ne = ye.call(x, Se, de, x, $)) : O(ye) && (ne = ye),
                  O(ne))
                )
        ...
        d = {
          ease: [
            ...
            function (l, E, m, O) {
              ...
              return (
                E +
                m * (-2.75 * S * N + 11 * N * N + -15.5 * S + 8 * N + 0.25 * l)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (l, E, m, O) {
              ...
              return (
                E +
                m * (0.3 * S * N + -1.6 * N * N + 2.2 * S + -1.8 * N + 1.9 * l)
              );
            },
          ],
          "ease-in-out": [
          ...
          "ease-in-out-expo": [
            ...
            function (l, E, m, O) {
              return l === 0
                ...
                ? E + m
                : (l /= O / 2) < 1
                ? (m / 2) * Math.pow(2, 10 * (l - 1)) + E
                : (m / 2) * (-Math.pow(2, -10 * --l) + 2) + E;
            },
          ],
          "ease-in-circ": [
          ...
          "ease-in-out-circ": [
            ...
            function (l, E, m, O) {
              return (l /= O / 2) < 1
                ? (-m / 2) * (Math.sqrt(1 - l * l) - 1) + E
                : (m / 2) * (Math.sqrt(1 - (l -= 2) * l) + 1) + E;
            },
          ],
          "ease-in-back": [
        ...
        X = function (l) {
          ...
          for (E = 0; E < I.length; E++)
            if (((m = I[E] + O), m in M.style))
              return { dom: m, css: L[E] + l };
        },
        q = (t.support = {
      ...
      var oe = (t.frame = (function () {
        ...
        Fe = p(function (l) {
          function E(z, ie) {
            ...
            if (!ie.weak || !this.props[ae]) {
              var Ne = me[0],
                Te = this.props[ae];
              return (
                Te || (Te = this.props[ae] = new Ne.Bare()),
            ...
            if (z) {
              ...
              if (ae == "object") {
                ...
                Se.call(
                  ...
                  de.call(this),
                  me > 0 &&
                    ((this.timer = new te({ duration: me, context: this })),
                    (this.active = !0),
          ...
          function de() {
            ...
            for (z in this.props)
              (ie = this.props[z]), ie.active && ce.push(ie.string);
            (ce = ce.join(",")),
              this.style !== ce &&
                ((this.style = ce), (this.el.style[q.transition.dom] = ce));
          }
          function Se(z, ie, ce) {
            var ae,
              me,
        ...
        C = p(function (l) {
          ...
          (l.init = function (S, W, $, k) {
            ...
            $[2] && (x = $[2]),
              ...
              (this.name = x),
              (this.type = $[1]),
              (this.duration = u(W[1], this.duration, N.duration)),
              (this.ease = m(W[2], this.ease, N.ease)),
              (this.delay = u(W[3], this.delay, N.delay)),
        ...
        J = p(function (l) {
          ...
          var W = { ease: d.ease[1], from: 0, to: 1 };
          (l.init = function (x) {
            ...
            ne === void 0 && (ne = W.from),
              de === void 0 && (de = W.to),
              (this.unit = x.unit || ""),
              typeof ne == "number" && typeof de == "number"
                ? ((this.begin = ne), (this.change = de - ne))
                : this.format(de, ne),
          ...
          (l.init = function (m) {
            ...
            (l.render = function (m) {
              ...
              for (O = S; O--; )
                (N = this.tweens[O]),
                  N.context &&
                    (N.render(m), (this.current[N.name] = N.value), (W = !0));
              return W
      ...
      (t.fallback = function (l) {
        ...
        (t.delay = function (l, E, m) {
          return new te({ complete: E, duration: l, context: m });
        }),
      ...
      var K = e.style,
        fe = e.css,
        pt = { transform: q.transform && q.transform.css },
        Ye = {
          color: [G, R],
        ...
        (e.debounce = function (I, L, X) {
          var q,
            ...
            Fe = function () {
              var Ee = e.now() - oe;
              Ee < L
                ? (q = setTimeout(Fe, L - Ee))
                : ((q = null), X || ((ve = I.apply(Y, ee)), (Y = ee = null)));
            };
          return function () {
...
` +
  ...
  var Ge = c((Aq, na) => {
    ...
    var Or;
    Jo &&
      oE.on("touchstart mousedown", function (e) {
        Or = e.target;
      });
    se.validClick = Jo
      ? function (e) {
    ...
    function ta() {
      rt && (rt.reject(), Le.off("load", rt.resolve)),
        (rt = new $e.Deferred()),
        ...
        function y(_) {
          if (!_.getAttribute("hreflang")) {
            ...
            if (((s.href = b), !(b.indexOf(":") >= 0))) {
              ...
              if (!(b === "#" || b === "")) {
                var P =
                  s.href === a.href || b === d || (f.test(b) && g.test(d));
                T(A, u, P);
              }
            }
          }
      ...
      (ua.exports = function (e) {
        ...
        function P(M) {
          if (
            ...
            r &&
            r.pushState &&
            !(En.env.chrome && n.protocol === "file:")
          ) {
            var I = r.state && r.state.hash;
            I !== M && r.pushState({ hash: M }, "", M);
          }
        }
        function w(M, I) {
          var L = o.scrollTop(),
          ...
          if (L !== X) {
            var q = U(M, L, X),
              ...
              Y = function () {
                var oe = Date.now() - ee;
                window.scroll(0, V(L, X, oe, q)),
                  oe <= q ? s(Y) : typeof I == "function" && I();
              };
            s(Y);
          }
        }
      ...
      (ha.exports = function (e) {
        ...
        function r(i) {
          ...
          function p(T) {
            ...
            (_ && _.length > 1) ||
              ((a = !0),
              _ ? ((s = !0), (f = _[0].clientX)) : (f = T.clientX),
              (g = f));
          }
          function d(T) {
            if (a) {
              ...
              (g = b),
                Math.abs(A) > u &&
                  n &&
                  String(n()) === "" &&
                  (o("swipe", T, { direction: A > 0 ? "right" : "left" }), y());
            }
          }
          function h(T) {
  ...
  var va = c((Pq, _a) => {
    ...
    wr.define(
      ...
      (_a.exports = function (e, t, n) {
        if (
          ((n = n || {}),
          (wr.env("test") || wr.env("frame")) && !n.fixture && !gE())
        )
          return { exit: 1 };
        var r = {},
          o = e(window),
  ...
  var Fr = c((Bt) => {
    ...
    var Ua = (Bt.ActionTypes = { INIT: "@@redux/INIT" });
    function Xa(e, t, n) {
      var r;
      if (
  ...
  var ka = c((Gr) => {
    ...
    function r_(e) {
      Object.keys(e).forEach(function (t) {
        var n = e[t],
          r = n(void 0, { type: Ba.ActionTypes.INIT });
        if (typeof r > "u")
          throw new Error(
            'Reducer "' +
              t +
      ...
      return function (r) {
        return function (o, i, a) {
          ...
          return (
            ...
            (u = c_.default.apply(void 0, f)(s.dispatch)),
            s_({}, s, { dispatch: u })
          );
        };
      };
  ...
  var Ka = c((kr) => {
    ...
    var A_ = {
      ...
      S_ = { ELEMENT: "ELEMENT", VIEWPORT: "VIEWPORT" },
      w_ = { X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS" },
      C_ = {
        CHILDREN: "CHILDREN",
        SIBLINGS: "SIBLINGS",
  ...
  var mt = c((le) => {
    ...
    function gs(e, t, n, r, o, i) {
      for (
        ...
        s[u - 6] = arguments[u];
      return s.length
        ? Ae.call.apply(Ae, [null, !1, !1, e, t, n, r, o, i].concat(s))
        : Ae(!1, !1, e, t, n, r, o, i);
    }
    function hs(e, t, n, r, o, i) {
      for (
        ...
        s[u - 6] = arguments[u];
      return s.length
        ? Ae.call.apply(Ae, [null, !1, !0, e, t, n, r, o, i].concat(s))
        : Ae(!1, !0, e, t, n, r, o, i);
    }
    function Es(e, t, n, r, o, i, a) {
      ...
      return (
        g.length
          ? (u = Ae.call.apply(Ae, [null, !1, !1, s, n, r, o, i, a].concat(g)))
          : (u = Ae(!1, !1, s, n, r, o, i, a)),
        Tn(e, t, u)
      );
    }
    function _s(e, t) {
    ...
    function vs(e, t, n, r, o, i) {
      for (
        ...
        s[u - 6] = arguments[u];
      return s.length
        ? Ae.call.apply(Ae, [null, !0, !1, e, t, n, r, o, i].concat(s))
        : Ae(!0, !1, e, t, n, r, o, i);
    }
    var Ay = {
      clone: yn,
  ...
  var ms = c((Jr) => {
    ...
    var by = Oe(),
      ...
      Py = { preview: {}, playback: {}, stop: {}, clear: {} },
      ...
      Hy = (e = Is, t) => {
        switch (t.type) {
          case xy: {
            ...
            return (0, Ue.merge)(e, { hasBoundaryNodes: n, reducedMotion: r });
          }
          case Fy:
          ...
          case By: {
            ...
            return (0, Ue.merge)(e, { viewportWidth: n, mediaQueryKey: i });
          }
          case Wy:
  ...
  var xn = c((P2, al) => {
    var pi = Kc(),
      ...
      qO = wt(_i),
      at = ol;
    ((pi && at(new pi(new ArrayBuffer(1))) != il) ||
      (gi && at(new gi()) != el) ||
      (hi && at(hi.resolve()) != tl) ||
      (Ei && at(new Ei()) != nl) ||
      (_i && at(new _i()) != rl)) &&
  ...
  var gl = c((L2, pl) => {
    ...
    function kO(e, t, n, r, o, i) {
      ...
      if (d && !g)
        return (
          i || (i = new vi()),
          a || XO(e) ? GO(e, t, n, r, o, i) : UO(e, t, u, n, r, o, i)
        );
      if (!(n & BO)) {
  ...
  var Dn = c((V2, wl) => {
    ...
    function hA(e, t) {
      ...
      return n == "number" ||
        ...
        dA(e)
        ? !0
        : gA.test(e) || !pA.test(e) || (t != null && e in Object(t));
    }
    wl.exports = hA;
  });
  var Nl = c((X2, Rl) => {
  ...
  var Li = c((Pi) => {
    ...
    var je = 1.70158,
      _S = (0, Hn.default)(0.25, 0.1, 0.25, 1),
      vS = (0, Hn.default)(0.42, 0, 1, 1),
      yS = (0, Hn.default)(0, 0, 0.58, 1),
  ...
  var Fi = c((xi) => {
    ...
    function ow(e, t, n) {
      return t === 0
        ...
        : t === 1
        ? 1
        : Mi(n ? (t > 0 ? n(t) : t) : t > 0 && e && xf[e] ? xf[e](t) : t);
    }
  });
  var Uf = c((qi) => {
    "use strict";
        ...
        switch (t.type) {
          ...
          case _w: {
            let {
              ...
              u = e;
            return (
              (0, zn.getIn)(u, [n, r]) !== r && (u = Gf(u, r, a, n, i)),
              Di(u, n, s, o, i)
            );
          }
          case vw: {
    ...
    function Gf(e, t, n, r, o) {
      let i =
        n === sw ? (0, zn.getIn)(o, ["config", "target", "objectId"]) : null;
            ...
            if (p != null) {
              if ((f.isPlaying || f.play(a, !1), Vi in s || Xi in s)) {
                let d = f.layout,
                  h = s[Vi] ?? d.fit,
                  y = s[Xi] ?? d.alignment;
                (h !== d.fit || y !== d.alignment) &&
                  (f.layout = d.copyWith({ fit: h, alignment: y }));
              }
              for (let d in s) {
    ...
    var eC = ki(),
      ...
      sC = (e, t, n) => {
        let {
          ...
          i = t.PLUGIN_VARIABLE,
          a = Object.values(aC).find((s) => s.match(i, o));
  ...
  var dd = c((G5, fd) => {
    ...
    function YC(e, t, n) {
      ...
      return (
        n !== void 0 &&
          ((o = zC(n)), (o = n < 0 ? jC(r + o, 0) : KC(o, r - 1))),
        kC(e, HC(t, 3), o, !0)
      );
    }
    fd.exports = YC;
  ...
  var Fd = c((ao) => {
    ...
    var {
      ...
      Rd = (e) => e.trim(),
      ro = Object.freeze({ [xt]: bd, [Ft]: gR, [Dt]: hR }),
      Nd = Object.freeze({
    ...
    function io({
      ...
      if (
        (D
          ? ((U = w.limitAffectedElements), (V = Q), (B = s(w)))
          : (V = B = s({ id: v, selector: _, selectorGuids: b })),
        t && R)
      ) {
        let M = n && (B || R === !0) ? [n] : u(Q);
        if (B) {
    ...
    var Id = /px/,
      ...
      NR = (e, t) =>
        t.reduce(
          (n, r) => (
            n[r.type] == null &&
              (n[r.type] = UR[r.type] || r.defaultValue || 0),
            n
          ),
          e || {}
        );
    function PR(e, t = {}, n = {}, r, o) {
      ...
      switch (r.actionTypeId) {
        ...
        case Cd:
          return { value: (0, et.default)(parseFloat(i(e, $n)), 1) };
        case Mt: {
          let s = i(e, Xe),
            u = i(e, Be),
            f,
          ...
          return (
            r.config.widthUnit === tt
              ...
              : (f = (0, et.default)(parseFloat(s), parseFloat(n.width))),
            r.config.heightUnit === tt
              ? (g = Id.test(u) ? parseFloat(u) : parseFloat(n.height))
        ...
        case Jn:
          return { value: (0, et.default)(i(e, Qn), n.display) };
        case yR:
    ...
    var LR = (e, t) => (t && (e[t.type] = t.value || 0), e),
      ...
      xR = (e, t, n) => {
        ...
        switch (e) {
          case an: {
            let r = (0, Ji.default)(n.filters, ({ type: o }) => o === t);
            return r ? r.value : 0;
          }
          case sn: {
            let r = (0, Ji.default)(n.fontVariations, ({ type: o }) => o === t);
            return r ? r.value : 0;
          }
          default:
            return n[t];
    ...
    function FR({ element: e, actionItem: t, elementApi: n }) {
      if ((0, We.isPluginType)(t.actionTypeId))
        return (0, We.getPluginDestination)(t.actionTypeId)(t.config);
      switch (t.actionTypeId) {
        ...
        case Mt: {
          ...
          if (!Ie.IS_BROWSER_ENV) return { widthValue: u, heightValue: f };
          if (a === tt) {
            let g = r(e, Xe);
    ...
    var oo = {
        [Nt]: Object.freeze({ xValue: 0, yValue: 0, zValue: 0 }),
      ...
      UR = Object.freeze({ wght: 0, opsz: 0, wdth: 0, slnt: 0 }),
      VR = (e, t) => {
    ...
    function QR(e, t, n, r, o, i) {
      ...
      switch (r.actionTypeId) {
        case Mt: {
          ...
          f !== void 0 &&
            (s === tt && (s = "px"), ct(e, Xe, i), a(e, Xe, f + s)),
            g !== void 0 &&
              (u === tt && (u = "px"), ct(e, Be, i), a(e, Be, g + u));
          break;
        }
        case an: {
          WR(e, n, r.config, i);
    ...
    function ZR(e, t, n) {
      ...
      switch (t.actionTypeId) {
        case Jn: {
          ...
          o === pR && Ie.IS_BROWSER_ENV
            ? r(e, Qn, Ie.FLEX_PREFIXED)
            : r(e, Qn, o);
          return;
        }
      }
    ...
    function JR({ store: e, elementApi: t }) {
      ...
      Object.keys(r).forEach((i) => {
        let a = r[i],
          ...
          { actionListId: u } = s,
          f = o[u];
        f && Td({ actionList: f, event: a, elementApi: t });
      }),
        Object.keys(o).forEach((i) => {
          Td({ actionList: o[i], elementApi: t });
        });
    }
    function Td({ actionList: e = {}, event: t, elementApi: n }) {
      ...
      r &&
        r.forEach((i) => {
          Od({ actionGroup: i, event: t, elementApi: n });
        }),
        o &&
          o.forEach((i) => {
            let { continuousActionGroups: a } = i;
            a.forEach((s) => {
              Od({ actionGroup: s, event: t, elementApi: n });
            });
          });
    }
    function Od({ actionGroup: e, event: t, elementApi: n }) {
      ...
      r.forEach((o) => {
        let { actionTypeId: i, config: a } = o,
          s;
        (0, We.isPluginType)(i)
          ? (s = (u) => (0, We.clearPlugin)(i)(u, o))
          : (s = Md({ effect: tN, actionTypeId: i, elementApi: n })),
    ...
    function eN(e, t, n) {
      ...
      o(e, Rt) && Md({ effect: Ld, actionTypeId: i, elementApi: n })(e);
    }
    var Md =
    ...
    function rN({ actionList: e, actionItemId: t, rawData: n }) {
      let { actionItemGroups: r, continuousParameterGroups: o } = e,
        i = [],
        a = (s) => (
          i.push((0, _d.mergeIn)(s, ["config"], { delay: 0, duration: 0 })),
          s.id === t
        );
      return (
  ...
  var Vd = c((co) => {
    ...
    var qd = Oe(),
      ...
      SN = (e, t) => {
        ...
        let A, R, P, w;
        for (let U = 0, { length: V } = o; U < V; U++) {
          let { keyframe: B, actionItems: Q } = o[U];
          if ((U === 0 && (A = Q[0]), b >= B)) {
            A = Q[0];
            let M = o[U + 1],
              I = M && b !== B;
            (R = I ? M.actionItems[0] : null),
              I && ((P = B / 100), (w = (M.keyframe - B) / 100));
          }
        }
        let D = {};
        if (A && !R)
          for (let U = 0, { length: V } = i; U < V; U++) {
            let B = i[U];
            D[B] = uo(u, B, A.config);
          }
        ...
        return (0, Gt.merge)(e, { position: _, current: D });
      },
      wN = (e, t) => {
        let {
            active: n,
        ...
        switch (t.type) {
          ...
          case vN: {
            ...
            return (0, Gt.set)(e, n, {
              ...
              skipToValue: U,
              customEasingFn:
                Array.isArray(I) && I.length === 4 ? TN(I) : void 0,
            });
          }
          case yN: {
  ...
  var Bd = c((fo) => {
    ...
    var xN = Wr(),
      ...
      UN = Vd(),
      VN = Xd(),
      { ixElements: XN } = GN.IX2ElementsReducer,
  ...
  var gp = c((tG, pp) => {
    ...
    function GP(e, t, n) {
      var r = e[t];
      (!(qP.call(e, t) && FP(r, n)) || (n === void 0 && !(t in e))) &&
        xP(e, t, n);
    }
    pp.exports = GP;
  });
  ...
  var $p = c((vG, Yp) => {
    ...
    function oM(e, t, n) {
      ...
      return (
        ...
        nM(e, t, { leading: r, maxWait: t, trailing: o })
      );
    }
    Yp.exports = oM;
  });
  var tr = c((vo) => {
    ...
    var Qp = Oe(),
      ...
      { reifyState: CM } = sM.IX2VanillaUtils,
      RM = (e) => ({ type: uM, payload: { ...CM(e) } }),
      ...
      FM = (e) => ({ type: gM, payload: { actionListId: e } }),
      DM = () => ({ type: hM }),
      qM = (e, t) => ({ type: EM, payload: { target: e, listenerParams: t } }),
      GM = (e = 1) => ({ type: _M, payload: { step: e } }),
      UM = (e, t) => ({ type: vM, payload: { stateKey: e, newState: t } }),
      VM = (e, t) => ({ type: yM, payload: { now: e, parameters: t } }),
      XM = (e, t) => ({ type: mM, payload: { key: e, value: t } }),
      BM = (e) => ({ type: IM, payload: { ...e } }),
      WM = (e, t) => ({ type: TM, payload: { instanceId: e, time: t } }),
      kM = (e) => ({ type: OM, payload: { instanceId: e } }),
      HM = (e, t, n, r) => ({
        type: AM,
  ...
  var eg = c((mo) => {
    ...
    function ix({ id: e, selector: t }) {
      if (e) {
        ...
        if (e.indexOf(Zp) !== -1) {
          let r = e.split(Zp),
            o = r[0];
          if (((n = r[1]), o !== document.documentElement.getAttribute(Jp)))
            return null;
        }
    ...
    function ox(e) {
      return e == null || e === document.documentElement.getAttribute(Jp)
        ? document
        : null;
    }
    function ax(e, t) {
    ...
    var fx = Element.prototype.closest
  ...
  var vg = c((CG, _g) => {
    ...
    function wx(e, t, n) {
      return (
        ...
        function () {
          for (
            var r = arguments, o = -1, i = Eg(r.length - t, 0), a = Array(i);
            ++o < i;
  ...
  var Oo = c((GG, Vg) => {
    ...
    function $x(e) {
      for (
        var t = e.name + "", n = Ug[t], r = Yx.call(Ug, t) ? n.length : 0;
        r--;
    ...
    function bF(e) {
      return _F(function (t) {
        ...
        for (r = a ? r : n; ++r < n; ) {
          ...
          !u[4].length &&
          u[9] == 1
            ? (a = a[Ao(u[0])].apply(a, u[3]))
            : (a = i.length == 1 && Zg(i) ? a[s]() : a.thru(i));
        }
        return function () {
          var f = arguments,
            g = f[0];
  ...
  var Ah = c((Po) => {
    ...
    var {
      ...
      { COLON_DELIMITER: sh } = ft.IX2EngineConstants,
      { getNamespacedParameterId: uh } = xF.IX2VanillaUtils,
      mh = (e) => (t) => typeof t == "object" && e(t) ? !0 : t,
      cn = mh(({ element: e, nativeEvent: t }) => e === t.target),
      nD = mh(({ element: e, nativeEvent: t }) => e.contains(t.target)),
      ke = (0, PF.default)([cn, nD]),
      Ih = (e, t) => {
        if (t) {
          let { ixData: n } = e.getState(),
            { events: r } = n,
      ...
      Ro = { types: Co },
      iD = { PAGE_START: vh, PAGE_FINISH: _h },
      un = (() => {
      ...
      sD = (e) => {
        let {
          ...
          { clientWidth: r, clientHeight: o } = un(),
      ...
      Oh = (e) => (t, n) => {
        let { type: r } = t.nativeEvent,
          o = [wo, yh].indexOf(r) !== -1 ? r === wo : n.isActive,
          i = { ...n, isActive: o };
      ...
      fh =
        (e) =>
        (t, n = {}) => {
          let { stiffScrollTop: r, scrollHeight: o, innerHeight: i } = un(),
            {
      ...
      cr = (e = !0) => ({
        ...
        handler: xe(
          e ? ke : cn,
          Oh((t, n) => (n.isActive ? ln.handler(t, n) : n))
        ),
      }),
      lr = (e = !0) => ({
        ...Th,
        handler: xe(
          e ? ke : cn,
          Oh((t, n) => (n.isActive ? n : ln.handler(t, n)))
        ),
      }),
      ph = {
        ...Ro,
      ...
      dD = {
        ...
        [HF]: cr(),
        [zF]: lr(),
        [eD]: { types: "ecommerce-cart-open", handler: xe(ke, be) },
        [JF]: { types: "ecommerce-cart-close", handler: xe(ke, be) },
        [FF]: {
          types: "click",
          handler: xe(
            ke,
          ...
          handler: (
            ...
            switch (a) {
              ...
              case ft.EventBasedOn.PAGE: {
                ...
                _ = v ? Math.min(R + h, w) / w : Math.min(P + y, D) / D;
                break;
              }
              ...
              default: {
                ...
                let P = t.getBoundingClientRect(),
                  { left: w, top: D, width: U, height: V } = P;
                if (!R && !cD({ left: p, top: d }, P)) break;
                (A = !0), (_ = v ? (p - w) / U : (d - D) / V);
                break;
              }
            }
            return (
              T && (_ > 1 - gh || _ < gh) && (_ = Math.round(_)),
              (a !== ft.EventBasedOn.ELEMENT || A || A !== i.elementHovered) &&
                ((_ = f ? 1 - _ : _),
                e.dispatch((0, ur.parameterChanged)(b, _))),
              { elementHovered: A, clientX: p, clientY: d, pageX: h, pageY: y }
            );
          },
        },
        [tD]: {
        ...
        [ZF]: {
          ...
          handler: (
            ...
            if (g === ft.EventBasedOn.VIEWPORT) {
              ...
              return (
                R !== o.scrollPercent &&
                  t.dispatch((0, ur.parameterChanged)(d, R)),
                { scrollPercent: R }
              );
            } else {
              let R = uh(r, d),
              ...
              return (
                I !== o.scrollPercent &&
                  t.dispatch((0, ur.parameterChanged)(R, I)),
                { scrollPercent: I }
              );
            }
          },
  ...
  var Lo = c((Xo) => {
    ...
    var TD = Object.keys(Ce.QuickEffectIds),
      ...
      VD = 12;
    function XD(e) {
      dt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: kD }),
        dt({
          store: e,
          select: ({ ixRequest: t }) => t.playback,
          onChange: HD,
        }),
        dt({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: zD }),
        dt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: jD });
    }
    function BD(e) {
      dt({
        store: e,
    ...
    function kD({ rawData: e, defer: t }, n) {
      let r = () => {
        hr({ store: n, rawData: e, allowEvents: !0 }), Ph();
      };
      t ? setTimeout(r, 0) : r();
    }
    function Ph() {
    ...
    function HD(e, t) {
      ...
      if (r && o && g && s) {
        ...
        p && (g = ND({ actionList: p, actionItemId: o, rawData: g }));
      }
      if (
        (hr({ store: t, rawData: g, allowEvents: a, testManual: u }),
        (r && n === Ce.ActionTypeConsts.GENERAL_START_ACTION) || Mo(n))
      ) {
        qo({ store: t, actionListId: r }),
          Mh({ store: t, actionListId: r, eventId: i });
        let p = Go({
          store: t,
          eventId: i,
          actionListId: r,
        ...
        f &&
          p &&
          t.dispatch(
            (0, pe.actionListPlaybackChanged)({
              actionListId: r,
              isPlaying: !s,
            })
          );
    ...
    function zD({ actionListId: e }, t) {
      e ? qo({ store: t, actionListId: e }) : xh({ store: t }), Er(t);
    }
    function jD(e, t) {
      Er(t), Nh({ store: t, elementApi: he });
    }
    function hr({ store: e, rawData: t, allowEvents: n, testManual: r }) {
      let { ixSession: o } = e.getState();
      t && e.dispatch((0, pe.rawDataImported)(t)),
        o.active ||
          (e.dispatch(
            (0, pe.sessionInitialized)({
          ...
          n &&
            (JD(e),
            KD(),
            e.getState().ixSession.hasDefinedMediaQueries && BD(e)),
          e.dispatch((0, pe.sessionStarted)()),
          YD(e, r));
    }
    function KD() {
    ...
    function YD(e, t) {
      let n = (r) => {
        ...
        o.active &&
          (e.dispatch((0, pe.animationFrameChanged)(r, i)),
          t ? WD(e, n) : requestAnimationFrame(n));
      };
    ...
    function $D({ target: e, listenerParams: t }) {
      ...
      _.forEach((R) => {
        ...
        T.forEach(({ element: R, key: P }) => {
          let w = v[P],
            ...
            { actionTypeId: U } = D,
            B = (
              U === Ce.ActionTypeConsts.PLUGIN_RIVE
                ? (D.config?.target?.selectorGuids || []).length === 0
                : gr(U)
            )
              ? Do(U)(R, D)
              : null,
            Q = Fo({ element: R, actionItem: D, elementApi: he }, B);
          Uo({
            store: e,
            element: R,
            eventId: r,
    ...
    function Lh(e) {
      ...
      if (r !== t.viewportWidth) {
        ...
        e.dispatch((0, pe.viewportWidthChanged)({ width: r, mediaQueries: o }));
      }
    }
    var nq = (e, t) => (0, ED.default)((0, vD.default)(e, t), _D.default),
      ...
      iq = (e) => {
        ...
        return dr({ config: t, elementApi: he });
      };
    function oq({ logic: e, store: t, events: n }) {
      ...
      (0, fn.default)(s, (p, d) => {
        let h = n[d],
          { action: y, id: v, mediaQueries: T = i.mediaQueryKeys } = h,
          { actionListId: _ } = y.config;
        DD(T, i.mediaQueryKeys) || t.dispatch((0, pe.mediaQueriesDefined)()),
          y.actionTypeId === Ce.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(h.config) ? h.config : [h.config]).forEach((A) => {
              let { continuousParameterGroupId: R } = A,
                P = (0, nt.default)(a, `${_}.continuousParameterGroups`, []),
                w = (0, gD.default)(P, ({ id: V }) => V === R),
                D = (A.smoothing || 0) / 100,
          ...
          (y.actionTypeId === Ce.ActionTypeConsts.GENERAL_START_ACTION ||
            Mo(y.actionTypeId)) &&
            Mh({ store: t, actionListId: _, eventId: v });
      });
      let u = (p) => {
          ...
          rq(s, (h, y, v) => {
            ...
            b.actionTypeId === Ce.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
          ...
          d.split(" ")
            ...
            .forEach((y) => {
              ...
              p.addEventListener(y, v),
                t.dispatch((0, pe.eventListenerAdded)(p, [y, v]));
            });
        };
    ...
    function aq(e) {
      ...
      for (let r in e) {
        let { eventTypeId: o, target: i } = e[r],
          a = he.getQuerySelector(i);
        t[a] ||
          ((o === Ce.EventTypeConsts.MOUSE_CLICK ||
            o === Ce.EventTypeConsts.MOUSE_SECOND_CLICK) &&
            ((t[a] = !0),
    ...
    function Mh({ store: e, actionListId: t, eventId: n }) {
          ...
          let { config: d, actionTypeId: h } = p,
            y =
              d?.target?.useEventTarget === !0 && d?.target?.objectId == null
                ...
                : d,
            v = dr({ config: y, event: s, elementApi: he }),
            T = gr(h);
          v.forEach((_) => {
            let b = T ? Do(h)(_, p) : null;
            Uo({
              destination: Fo({ element: _, actionItem: p, elementApi: he }, b),
              immediate: !0,
              store: e,
              element: _,
              eventId: n,
    ...
    function qo({
      ...
      let { ixInstances: i, ixSession: a } = e.getState(),
        s = a.hasBoundaryNodes && n ? he.getClosestElement(n, fr) : null;
      (0, fn.default)(i, (u) => {
    ...
    function Go({
      ...
      let { ixData: u, ixSession: f } = e.getState(),
        ...
        h = (0, nt.default)(u, `actionLists.${o}`, {}),
        { actionItemGroups: y, useFirstGroupAsInitialState: v } = h;
      if (!y || !y.length) return !1;
      i >= y.length && (0, nt.default)(p, "config.loop") && (i = 0),
        i === 0 && v && i++;
      let _ =
          (i === 0 || (i === 1 && v)) && Mo(p.action?.actionTypeId)
            ? p.config.delay
            : void 0,
      ...
      return (
        b.forEach((w, D) => {
          ...
          dr({
            ...
            P = !0;
            let Y = R === D && X === 0,
              oe = CD({ element: L, actionItem: w }),
              ve = Fo({ element: L, actionItem: w, elementApi: he }, q);
            Uo({
              store: e,
              element: L,
              actionItem: w,
    ...
    function Uo(e) {
      let { store: t, computedStyle: n, ...r } = e,
        ...
        p = !u,
        d = bD(),
        { ixElements: h, ixSession: y, ixData: v } = t.getState(),
        T = AD(h, o),
        { refState: _ } = h[T] || {},
        b = he.getRefType(o),
        A = y.reducedMotion && Ce.ReducedMotionTypes[i.actionTypeId],
        R;
      if (A && u)
      ...
      if (
        ...
        Fh(document.body, "ix2-animation-started", d),
        a)
      ) {
        sq(t, d);
        return;
      }
      dt({ store: t, select: ({ ixInstances: w }) => w[d], onChange: Dh }),
    ...
    function sq(e, t) {
      ...
      e.dispatch((0, pe.instanceStarted)(t, 0)),
        e.dispatch((0, pe.animationFrameChanged)(performance.now(), n));
  ...
  var Uh = c((Wo) => {
    ...
    function hq(e) {
      Gh(), (0, Bo.startEngine)({ store: _r, rawData: e, allowEvents: !0 });
    }
    function Gh() {
      (0, Bo.stopEngine)(_r);
    }
  ...
  var zh = c((ZG, Hh) => {
    ...
    var ko = window.jQuery,
      ...
      yr = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), ko(t).triggerHandler(He.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), ko(t).triggerHandler(He.types.OUTRO));
        },
      };
    He.triggers = {};
    He.types = { INTRO: "w-ix-intro" + kh, OUTRO: "w-ix-outro" + kh };
    He.init = function () {
  ...
  var $h = c((JG, Yh) => {
    ...
    mr.triggers = {};
    mr.types = { INTRO: "w-ix-intro" + Kh, OUTRO: "w-ix-outro" + Kh };
    ...
    Ir.define(
      ...
      (Zh.exports = function (e, t) {
        ...
        function D(C, G) {
          var H = e(G),
            F = e.data(G, u);
          F || (F = e.data(G, u, { form: H })), V(F);
          var J = H.closest("div.w-form");
          (F.done = J.find("> .w-form-done")),
            (F.fail = J.find("> .w-form-fail")),
            (F.fileUploads = J.find(".w-file-upload")),
        ...
        function U() {
          ...
          o.on(
            ...
            o.on("change", u + ' form input[type="radio"]', (j) => {
              e(`input[name="${j.target.name}"]:not(${C})`).map((fe, pt) =>
                e(pt).siblings(G).removeClass(H)
              );
              let K = e(j.target);
            ...
            re.forEach(([j, K]) => {
              o.on(
                ...
                (fe) => {
                  e(fe.target).siblings(K).addClass(F),
            ...
            C.find(':input:not([type="submit"]):not([type="file"])').each(
              function (F, J) {
                ...
                if (re === "checkbox") K = te.is(":checked");
                  ...
                  K =
                    C.find(
                      'input[name="' + te.attr("name") + '"]:checked'
                    ).val() || null;
                }
        ...
        function M(C) {
          var G = {};
          return (
            C.find(':input[type="file"]').each(function (H, F) {
              var J = e(F),
          ...
          return (
            G === "password"
              ...
              ? F
                ? g.test(C.attr("type")) &&
                  (p.test(F) ||
                    (J = "Please enter a valid email address for: " + H))
                : (J = "Please fill out the required field: " + H)
        ...
        function ee(C) {
          ...
          (j = te.substring(j, te.indexOf("&", j))),
            (H["b_" + re + "_" + j] = ""),
            e
              .ajax({ url: te, data: H, dataType: "jsonp" })
              .done(function (K) {
        ...
        function ve(C, G) {
          ...
          if (
            (h ||
              fe.on("click keydown", function (k) {
                (k.type === "keydown" && k.which !== 13 && k.which !== 32) ||
                  (k.preventDefault(), K.click());
              }),
